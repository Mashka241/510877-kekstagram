...
(function () {
  ...
  window.renderBigPicture = function (data) {
    ...
    for (var index = 0; index < data.comments; index++) {
      var comment = '<li class="social__comment social__comment--text"><img class="social__picture" src="img/avatar-' + window.util.getRandomNumber(1, 6) + '.svg" alt="Аватар комментатора фотографии" width="35" height="35"><p class="social__text">' + data.commentsContent[index] + '</p></li>';
